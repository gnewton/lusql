...
/**
 * Describe class TeeDocSink here.
 *
 *
 * Created: Fri Jul 30 11:44:07 2010
 *
    ...
    extends AbstractDocSink
{
    ...
    /**
     * Creates a new <code>TeeDocSink</code> instance.
     *
     */
    public TeeDocSink() {
    ...
    public Properties explainProperties()
	{
	    ...
	    p.setProperty(TeeDocSinkKey, "Class name of DocSink, with the number N and a colon prepended to the value. For example, to use 2 Sinks, ca.gnewton.lusql.driver.lucene.LuceneDocSink and ca.gnewton.lusql.driver.file.PrintDocSink, you would use the following: "
